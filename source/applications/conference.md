...
Conferences are used to set up conference rooms with a name, description,
...
-   **Description:** A way to organize what the conference's purpose is.

## Enable Conferences

By default, Conferences used to be hidden from the menu.

-   To add Conferences to the menu go to **Advanced \> Menu Manager** and
    then click the pencil edit icon on the right
